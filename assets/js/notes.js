...
$(function (){
    ...
    $.extend(notes, {
        ...
        addNote: function () {
            var $note = $('<div class="note-item media current fade in"><button class="close" onclick="deleteNote();" data-dismiss="alert">×</button><div><div><h4 class="note-name" id="noteName">Untitled</h4></div><p id="noteBody" class="note-desc">No content</p><p><small class="pull-right note-date"></small></p></div></div>');
