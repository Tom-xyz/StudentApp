$(function () {
    ...
    function runCalendar() {
        ...
        var calendar = $('#calendar').fullCalendar({
            ...
            events: {
                url: 'assets/php/getCalender.php',
                type: 'POST',
                error: function() {
                    alert('there was an error while fetching events!');
                },
                color: '#18a689',   // a non-ajax option
            ...
            select: function (start, end, allDay) {
                ...
                form.find(".row").append("<div class='col-md-6'><div class='form-group'><label class='control-label'>Event Name</label><input class='form-control' placeholder='Insert Event Name' type='text' name='title'/></div></div>").append("<div class='col-md-6'><div class='form-group'><label class='control-label'>Category</label><select class='form-control' name='category'></select></div></div>").find("select[name='category']").append("<option value='bg-red'>Presentation</option>")
                    .append("<option value='bg-green'>Deadline</option>").append("<option value='bg-purple'>Exam</option>").append("<option value='bg-blue'>Lunch</option>").append("<option value='bg-yellow'>Study</option>");
